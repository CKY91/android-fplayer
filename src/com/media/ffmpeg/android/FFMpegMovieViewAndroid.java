...
public class FFMpegMovieViewAndroid extends SurfaceView {
    ...
    private void openVideo() {
    	try {
			...
			Log.e(TAG, "mPlayer.setDisplay IllegalStateException Couldn't prepare player: " + e.getMessage());
		} catch (IOException e) {
	   	...
	   	try {
			...
			Log.e(TAG, "mPlayer.prepare() IllegalStateException Couldn't prepare player: " + e.getMessage());
		} catch (IOException e) {
			Log.e(TAG, "mPlayer.prepare() IOException Couldn't prepare player: " + e.getMessage());
		}
    }
